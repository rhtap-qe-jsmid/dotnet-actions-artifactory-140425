...
export IMAGE_URL=${IMAGE_URL-artifactory-docker-artifactory-jcr.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/dotnet-actions-artifactory-140425:$CI_TYPE-$TAG}
